...
public class Purchase extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        calculateButton.setFont(new java.awt.Font("Segoe UI Semibold", 1, 12)); // NOI18N
    ...
    public void updateTable(String ii){
...
// TODO add your handling code here:
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            ResultSet rs1 = s.executeQuery ("select quantity from  items where item_id="+"'"+id+"'");
            while(rs1.next()) {
                String id1 = rs1.getString("quantity");
                int id2 = Integer.parseInt(id1);
                int id3 = id2 + Integer.parseInt(quantity);
                s.executeUpdate("Update items set quantity=" + id3 + " where item_id=" + "'" + id + "'");
    ...
    public void workWithDatabase() {
        ...
        {
            JOptionPane.showMessageDialog(null, "Items not Available",
